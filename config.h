// This is just ripped from a BZFlag build on my Debian 11 system.
// Feel free to replace with your own if it doesn't work.
...
#define PACKAGE_STRING "BZFlag 2.5.3"
